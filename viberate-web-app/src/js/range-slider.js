(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define === "function" && define.amd) define("rangeSlider", [], factory);
  else if (typeof exports === "object") exports["rangeSlider"] = factory();
  else root["rangeSlider"] = factory();
})(window, function() {
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var RangeSlider = (function() {
            function RangeSlider(element, options) {
              ...
              this.value = func.getFirsNumberLike(
                this.options.value,
                this.element.value,
                parseFloat(this.element.value || this.min + (this.max - this.min) / 2)
              );

              this.step = func.getFirsNumberLike(
                this.options.step,
                    ...
                    dom.forEachAncestors(
                      ...
                      function(el) {
                        return (isEventOnSlider =
                          el.id === _this.identifier && !dom.hasClass(el, _this.options.disabledClass));
                      },
                      true
                    );
                ...
                },
                {
                  ...
                  value: function _setPosition(pos) {
                    ...
                    if (this.isInteractsNow || this.needTriggerEvents) {
                      if (
                        this.onSlideStart &&
                        typeof this.onSlideStart === "function" &&
                        this.onSlideEventsCount === 0
                      ) {
                ...
                },
                {
                  ...
                  value: function _getRelativePosition(e) {
                    ...
                    if (typeof e[pagePositionProperty] !== "undefined") {
                      pageOffset =
                        e.touches && e.touches.length ? e.touches[0][pagePositionProperty] : e[pagePositionProperty];
                      ...
                      e.currentPoint &&
                      (typeof e.currentPoint.x !== "undefined" || typeof e.currentPoint.y !== "undefined")
                    ) {
  ...
  \**************************/
        ...
        /***/ function(module, exports, __webpack_require__) {
           ...
           * @param {Function} listener
           */
          var removeEventListeners = (exports.removeEventListeners = function removeEventListeners(
            el,
            events,
            listener
          ) {
           ...
           * @param {HTMLElement} el DOM element
           */
          var removeAllListenersFromEl = (exports.removeAllListenersFromEl = function removeAllListenersFromEl(
            instance,
            el
          ) {
            if (!el[EVENT_LISTENER_LIST]) {
