...
!(function(e, t, n) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses &&
      ((t += " " + n + e.join(" " + n)), j ? (T.className.baseVal = t) : (T.className = t));
  }
  function a(e, t) {
    if ("object" == typeof e) for (var n in e) N(e, n) && a(n, e[n]);
    else {
      e = e.toLowerCase();
      var r = e.split("."),
        o = Modernizr[r[0]];
  ...
  function f() {
    var e = t.body;
    return e || ((e = s(j ? "svg" : "body")), (e.fake = !0)), e;
  }
  function c(e, n, r, o) {
    var i,
      a,
  ...
  function g(e, t, o, i) {
    ...
    for (var f, c, p, m, h, g = ["modernizr", "tspan", "samp"]; !L.style && g.length; )
      (f = !0), (L.modElem = s(g.shift())), (L.style = L.modElem.style);
    for (p = e.length, c = 0; p > c; c++)
      if (((m = e[c]), (h = L.style[m]), d(m, "-") && (m = l(m)), L.style[m] !== n)) {
  ...
  var x = "Moz O ms Webkit",
    w = b._config.usePrefixes ? x.toLowerCase().split(" ") : [];
  b._domPrefixes = w;
  var N,
    T = t.documentElement,
    j = "svg" === T.nodeName.toLowerCase();
  !(function() {
  ...
  var P = b._config.usePrefixes ? x.split(" ") : [];
  b._cssomPrefixes = P;
  var z = function(t) {
    var r,
      o = _.length,
  ...
  var A = function(e, t) {
    ...
    if (e in o) {
      var i = w.length;
      for (o[e] = t, n = o[e]; i-- && !n; ) (o[e] = "-" + w[i] + "-" + t), (n = o[e]);
    }
    return "" === n && (n = !1), n;
  };
  b.prefixedCSSValue = A;
  var F = (function() {
  ...
  b.mq = F;
  var M = ((b.testStyles = c), { elem: s("modernizr") });
  Modernizr._q.push(function() {
    delete M.elem;
  });
  var L = { style: M.elem.style };
  ...
  var $ = (b.prefixed = function(e, t, n) {
    return 0 === e.indexOf("@") ? z(e) : (-1 != e.indexOf("-") && (e = l(e)), t ? y(e, t, n) : y(e, "pfx"));
  });
  ...
  j ||
    !(function(e, t) {
      ...
      function a(e, n, r) {
        ...
        return (
          (o = r.cache[e]
            ...
            : r.createElem(e)),
          !o.canHaveChildren || S.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
        );
      }
      function s(e, n) {
      ...
      function f(e) {
        for (
          var t, n = e.getElementsByTagName("*"), o = n.length, i = RegExp("^(?:" + r().join("|") + ")$", "i"), a = [];
          o--;

        )
          (t = n[o]), i.test(t.nodeName) && a.push(t.applyElement(c(t)));
        return a;
      }
      function c(e) {
